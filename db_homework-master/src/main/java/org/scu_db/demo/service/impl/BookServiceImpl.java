...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public Integer findCallNumber() {
        return bookRepository.findCallNumber();
    ...
    @Override
    public List<Integer> findAllBookId() {
        return bookRepository.findAllBook_id();
    }
    @Override
    ...
    @Override
    public List<String> findSomeOfCallNunber() {
        return bookRepository.findSomeOfCallNunber();
    }
    @Override
